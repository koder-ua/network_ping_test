...
* asyncio\_proto - asyncio на протоколах. Фактически аналог twisted protocols [2]
* asyncio\_sock - asyncio с "сырыми" сокетами, используя ev\_loop.sock\_recv/ev\_loop.sock\_sendall
* gevent - [3]
...
* uvloop,uvloop\_proto,uvloop\_sock - тот же код что и для asyncio,asyncio\_proto и asyncio\_sock,
    соответсвенно, но вместо asyncio.new\_event\_loop использовалось uvloop.new\_event\_loop
    библиотеки uvloop [5]
