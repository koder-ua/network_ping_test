...
for i in $(seq 1 $ROUNDS); do
    for THCOUNT in 15000 20000 25000 30000 35000 40000 45000 50000 55000; do
        date
        echo "round $i"
        taskset -c 0 python3.5 main.py -i $BIND_IP --runtime $RUNTIME -s $SIZE $SERVER_IP $THCOUNT $FUNCS 2>&1 | tee -a $RESULT_FILE
    done
